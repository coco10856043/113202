...
# 註冊動作
#-----------------------
UPLOAD_FOLDER = 'story/static/avatar'  # 設定文件上傳目錄
...
# 生成圖片
#-----------------------
save_folder = 'story/static/image/story_select'
...
def generate_single_image(prompt, i):
    try:
        ...
        if image_response.status_code == 200:
            ...
            # Return relative URL
            relative_path = os.path.relpath(image_path, start='story/static')
...
def save_story():
    try:
        ...
        # 移動封面圖片
        source = "story/static/image/story_select"
        destination_cover = "story/static/image/story_cover"
        destination_page = "story/static/image/page"
