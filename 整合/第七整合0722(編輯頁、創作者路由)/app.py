...
#生圖測試1(成功用OPENAI函數)
save_folder = r"C:\Users\chang\Desktop\第七整合0718(追蹤鈕2改)\static\image\story"
...
def user_details():
    name = request.args.get('user-details')
    return render_template('user-details.html', name = name)
