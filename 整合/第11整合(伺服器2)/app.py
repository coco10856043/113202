...
def create_name():
    ...
    run = client.beta.threads.runs.create(
        thread_id=thread.id,
        assistant_id='OPENAI_API_KEY', # 助理名稱：story_name
    )
...
def create_detail():
    ...
    run = client.beta.threads.runs.create(
        thread_id=thread.id,
        assistant_id='asst_mV6FMtYCMXmmaPvsjy4VMZms', # 助理名稱：story_detail
    )
...
def creation():
    ...
    run = client.beta.threads.runs.create(
        thread_id=thread.id,
        assistant_id='asst_lXOk1lXER34dKCtkdNr6bfZz', # 助理名稱：story
    )
